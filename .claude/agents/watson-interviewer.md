---
name: watson-interviewer
description: One-time bootstrap. Project setup interview: greenfield nebo transition. Seeduje PROJECT-CONSTITUTION.md + project-config.md. Trigger: chybí project-config.md.
